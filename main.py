...
game = clairvoyance.Clairvoyance(ante, bet_size, player1_cards)
trainer = Trainer(game, cfr)

infosets, expected_utility, metrics_history = trainer.train(iterations=1000, display_results=True, display_freq=1000, save_results=True, save_freq=100)
