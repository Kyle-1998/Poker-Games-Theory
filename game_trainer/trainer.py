...
class Trainer:
    ...
    def train(self, iterations=1000, display_results=True, display_freq=100, save_results=False, save_freq=100, save_dir=os.path.join(_ROOT_DIR,"game_trainer",".logs")):
        '''
        ...
        for i in tqdm(range(iterations)):
            ...
            if hasattr(self.game, "get_metrics"):
                metrics = self.game.get_metrics(infosets, expected_game_value, i + 1)
        ...
        return infosets, expected_game_value, metrics_history
